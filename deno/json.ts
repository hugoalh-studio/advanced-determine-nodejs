import { ArrayItemFilter } from "./array.ts"
import { checkNumber, checkNumberIPS, checkNumberIPSWithMaximum } from "./internal/check-item.ts"
import { PlainObjectItemFilter } from "./plain-object.ts"
