 ...
 * @param {boolean} [option.strict=false] Use strict to not allow type of array as the root of the JSON; and any hyphen (`-`), star (`*`), or whitespace character(s) in the JSON key.
