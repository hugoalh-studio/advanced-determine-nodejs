 ...
 * @param {boolean} [option.strict=false] Use strict to not allow type of array as the root of the JSON; and not allow any illegal namespace character(s) in the JSON key.
 * @param {boolean} [option.strictKey=false] Use strict key to not allow any illegal namespace character(s) in the JSON key.
...
function isJSON(item, option = {}) {
	...
	let itemIsArray = isArray(item);
	if (runtime.allowArrayRoot === false && itemIsArray !== false) {
		return false;
	};
