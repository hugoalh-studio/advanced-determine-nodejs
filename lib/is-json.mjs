...
function isJSON(item, {
	...
	if (!isNumber(minimumEntries, {
		...
		throw new TypeError(`Argument \`minimumEntries\` must be type of number (integer, positive, and safe) and less than or equal to argument \`maximumEntries\`'s value!`);
	}
