...
function isFunction(item, option = {}) {
	...
	option.asynchronous ??= option.async;
	...
	if (
		...
		(option.asynchronous === false && isAsyncFunction(item)) ||
		(option.asynchronous === true && !isAsyncFunction(item)) ||
		(option.generator === false && isGeneratorFunction(item)) ||
		(option.generator === true && !isGeneratorFunction(item)) ||
