...
function isFunction(item, option = {}) {
	...
	if (
		...
		(option.asynchronous === false && utilTypes.isAsyncFunction(item)) ||
		(option.asynchronous === true && !utilTypes.isAsyncFunction(item)) ||
		(option.generator === false && utilTypes.isGeneratorFunction(item)) ||
		(option.generator === true && !utilTypes.isGeneratorFunction(item)) ||
