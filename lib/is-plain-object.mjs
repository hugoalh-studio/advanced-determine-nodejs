...
function isPlainObject(item, option = {}) {
	...
	let itemIsPlainObject = $isPlainObject(
		item,
		{
			configurable: option.elementsConfigurable,
			enumerable: option.elementsEnumerable,
			get: option.containGetters,
			set: option.containSetters,
			symbol: option.keysSymbols,
			writable: option.elementsWritable
		}
	);
