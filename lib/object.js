...
class ObjectItemFilter {
	...
	constructor({
		...
		if (typeof allowArray !== "boolean") {
			throw new TypeError(`Argument \`allowArray\` must be type of boolean!`);
		}
		if (typeof allowNull !== "boolean") {
			throw new TypeError(`Argument \`allowNull\` must be type of boolean!`);
		}
		if (typeof allowRegExp !== "boolean") {
			throw new TypeError(`Argument \`allowRegExp\` must be type of boolean!`);
		}
