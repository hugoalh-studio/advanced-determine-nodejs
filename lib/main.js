...
const biginteger = require("./isbiginteger.js");
const bigintegernegative = require("./isbigintegernegative.js");
const bigintegerpositive = require("./isbigintegerpositive.js");
...
const numberinteger = require("./isnumberinteger.js");
const numbersafeinteger = require("./isnumbersafeinteger.js");
module.exports.allIs = batch.allIs;
module.exports.allIsNot = batch.allIsNot;
module.exports.bigint = biginteger;
module.exports.biginteger = biginteger;
module.exports.bigintegernegative = bigintegernegative;
module.exports.bigintegerpositive = bigintegerpositive;
module.exports.bigintngt = bigintegernegative;
module.exports.bigintpst = bigintegerpositive;
...
module.exports.numberinteger = numberinteger;
module.exports.numbersafeinteger = numbersafeinteger;
module.exports.numint = numberinteger;
module.exports.numsint = numbersafeinteger;
