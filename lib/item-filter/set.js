...
class SetItemFilter {
	...
	constructor({
		...
		maximumSize = undefinish(maximumSize, aliases.maxSize, aliases.maximumSizes, aliases.maxSizes, Infinity);
		...
		minimumSize = undefinish(minimumSize, aliases.minimumSizes, aliases.minSize, aliases.minSizes, 1);
