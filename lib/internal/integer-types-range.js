...
function integerTypesRange(name, asNumber = false) {
	switch (name) {
		...
		case "int8":
		case "Int8":
			return integerTypesRangeOutput([int8Minimum, int8Maximum], asNumber);
		case "int16":
		case "Int16":
		case "short":
		case "Short":
			return integerTypesRangeOutput([int16Minimum, int16Maximum], asNumber);
		case "int32":
		case "Int32":
		case "rune":
		case "Rune":
			return integerTypesRangeOutput([int32Minimum, int32Maximum], asNumber);
		case "int64":
		case "Int64":
		case "long":
		case "Long":
			return integerTypesRangeOutput([int64Minimum, int64Maximum], asNumber);
		case "byte":
		case "Byte":
		case "uchar":
		case "Uchar":
		...
		case "Uint8":
		case "UInt8":
			return integerTypesRangeOutput([uintMinimum, uint8Maximum], asNumber);
		case "uint16":
		case "Uint16":
		case "UInt16":
		case "ushort":
		case "Ushort":
		case "UShort":
			return integerTypesRangeOutput([uintMinimum, uint16Maximum], asNumber);
		case "uint32":
		case "Uint32":
		case "UInt32":
			return integerTypesRangeOutput([uintMinimum, uint32Maximum], asNumber);
		case "uint64":
		case "Uint64":
		case "UInt64":
		case "ulong":
		case "Ulong":
		case "ULong":
			return integerTypesRangeOutput([uintMinimum, uint64Maximum], asNumber);
		default:
