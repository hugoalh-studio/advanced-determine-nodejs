...
function isArray(item, option = {}) {
	...
	option.maximumLength ??= option.maxLength ?? option.maximumElements ?? option.maxElements ?? Infinity;
	...
	option.minimumLength ??= option.minLength ?? option.minimumElements ?? option.minElements ?? 0;
