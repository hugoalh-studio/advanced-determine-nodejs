...
class ArrayItemFilter {
	...
	constructor({
		...
		lengthMinimum = undefinish(lengthMinimum, aliases.minLength, aliases.minimumElements, aliases.minElements, 1);
		...
		this.#lengthMaximum = undefinish(length, lengthMaximum);
		this.#lengthMinimum = undefinish(length, allowEmpty ? 0 : lengthMinimum);
		this.#strict = strict;
		this.#unique = unique;
	}
	/**
