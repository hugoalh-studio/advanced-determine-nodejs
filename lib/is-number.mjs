import isPlainObjectInno from "./internal/is-plain-object.mjs";
...
function isNumber(item, option = {}) {
	...
	if (
		...
		(option.prime === false && itemIsSafeInteger === true && isPrimeNumber(item) === true) ||
		(option.prime === true && (
			itemIsSafeInteger === false ||
			isPrimeNumber(item) === false
		)) ||
		((
			option.safe === true ||
			option.unsafe === false
