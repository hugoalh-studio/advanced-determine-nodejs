 ...
 * @throws {TypeError} Argument `generator` is not type of boolean or undefined.
 */
function isFunction(item, {
	...
	if (
		...
		(asynchronous === false && utilTypes.isAsyncFunction(item)) ||
		(asynchronous === true && !utilTypes.isAsyncFunction(item)) ||
		(generator === false && utilTypes.isGeneratorFunction(item)) ||
		(generator === true && !utilTypes.isGeneratorFunction(item)) ||
