/*==================
Advanced Determine - Is Undefined
	Language:
		NodeJS/14.15.0
==================*/
...
function isUndefined(item, option = {}) {
	...
	if (isObjectPair(option) === false) {
		throw new TypeError(`Argument "option" must be type of object pair! (Advanced Determine - Is Undefined)`);
	};
	if (typeof option.allowStringify !== "undefined") {
		if (typeof option.allowStringify !== "boolean") {
			throw new TypeError(`Argument "option.allowStringify" must be type of boolean! (Advanced Determine - Is Undefined)`);
		};
