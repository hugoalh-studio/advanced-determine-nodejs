 ...
 * @param {boolean} [option.strict=false] Use strict to not allow type of array as the root of the stringify JSON; and not allow any illegal namespace character(s) in the stringify JSON key.
 * @param {boolean} [option.strictKey=false] Use strict key to not allow any illegal namespace character(s) in the stringify JSON key.
