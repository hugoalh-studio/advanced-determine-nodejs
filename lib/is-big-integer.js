 ...
 * @param {boolean} [option.even] An even big integer number.
 ...
 * @param {boolean} [option.odd] An odd big integer number.
...
function isBigInteger(item, option = {}) {
	...
	if (
		typeof item !== "bigint" ||
		(option.even === false && item % 2n === 0n) ||
		(option.even === true && item % 2n !== 0n) ||
		...
		(option.odd === false && item % 2n !== 0n) ||
		(option.odd === true && item % 2n === 0n) ||
