...
class JSONItemFilter {
	...
	constructor({
		...
		strictKeys = undefinish(strictKeys, aliases.keysStrict, false);
		...
		if (!(keysPattern instanceof RegExp) && typeof keysPattern !== "undefined") {
			throw new TypeError(`Argument \`keysPattern\` must be instance of regular expression, or type of undefined!`);
		}
