...
class BigIntegerItemFilter {
	...
	constructor({
		...
		if (!(typeof minimum === "bigint" && minimum <= maximum) && typeof minimum !== "undefined") {
			throw new TypeError(`Argument \`minimum\` must be type of big integer${typeof maximum === "bigint" ? ` and <= ${maximum},` : ""} or undefined!`);
		}
