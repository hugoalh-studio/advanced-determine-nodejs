...
/**
 * @access private
 * @function areEqualObjectProperties
 * @param {object} item1 Item 1.
 * @param {object} item2 Item 2.
 * @returns {boolean}
 */
function areEqualObjectProperties(item1, item2) {
...
function areEqualInternal(item1, item2) {
	...
	if (
		...
		return ((Object.entries(item1).length === Object.entries(item2).length) ? areEqualObjectProperties(item1, item2) : false);
	}
	try {
