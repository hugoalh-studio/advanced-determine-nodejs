...
function isString(item, option = {}) {
	...
	if (typeof option.allowWhitespace !== "undefined") {
		console.warn(`Argument "option.allowWhitespace" is deprecated and will be remove at v5.1.0! For alternative method, use \`String.trim()\`, \`String.trimEnd()\`, or \`String.trimStart()\` instead.`);
