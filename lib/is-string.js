...
const undefinish = require("./internal/undefinish.js");
/**
 * @function isString
 * @alias isStr
...
function isString(item, option = {}) {
	...
	option.allowNonASCIICharacter = undefinish(option.allowNonASCIICharacter, true);
	...
	option.allowWhitespace = undefinish(option.allowWhitespace, true);
