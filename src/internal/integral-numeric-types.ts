 ...
 */
function integralNumericTypesRangeIntBase(base: bigint): [bigint, bigint] {
 ...
 * @returns {[bigint, bigint]}
 */
function integralNumericTypesRangeUIntBase(base: bigint): [bigint, bigint] {
 ...
 * @returns {[bigint, bigint]}
 */
function integralNumericTypeRange(typeName: string): [bigint, bigint] {
	switch (typeName) {
		case "char":
		case "Char":
		case "int8":
