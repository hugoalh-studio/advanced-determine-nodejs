 ...
 */
function integerTypesRangeInt(base: bigint): [bigint, bigint] {
 ...
 * @returns {[bigint, bigint]}
 */
function integerTypesRangeUInt(base: bigint): [bigint, bigint] {
 ...
 * @returns {[bigint, bigint]}
 */
function integerTypesRange(name: string): [bigint, bigint] {
	switch (name) {
		case "char":
		case "Char":
		case "int8":
